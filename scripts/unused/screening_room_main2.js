		...
		//if this VideoGroup object DOES exist
			...
			$.each(response.items, function (i, item) {
				...
				if (videoController instanceof BrightcoveVideoController)
					...
					this_video = new Video(item.id.videoId, this.truncate(item.snippet.title, 50), this.truncate(item.snippet.description, 30), "" + YOUTUBE_PLAY_URL + item.id.videoId, item.snippet.thumbnails.medium.url);
